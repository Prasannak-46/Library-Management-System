...
async function generateClearanceForm(data, fileName) {
  ...
  /* ################### TEXT ##################### */
  doc.fontSize(10).fill("#021c27").text("VIT AP,AMARAVATI", {
    align: "center",
  });
  jumpLine(doc, 1);
  ...
  doc
    .fontSize(10)
    .text(
      `This is to certify that ${data?.studentName} (${data?.studentRollNumber}) has successfully met all academic and administrative requirements at VIT AP , AMARAVATI. The requested clearance for Graduation has been approved by Librarian, HOD and Clerk.`,
      {
        align: "center",
      }
    );
